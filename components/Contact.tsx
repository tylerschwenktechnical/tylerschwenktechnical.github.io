          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  <svg className="w-6 h-6 text-primary-600 mr-3 mt-0.5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start">
                  ...
                  <div className="min-w-0">
                    ...
                    <a 
                      ...
                      className="text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 font-medium break-all"
                    >
                      linkedin.com/in/tyler-schwenk-939570224
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-lg p-6 min-w-0">
